...
def merge_pr():
  req = requests.put("https://www.github.com/grohit/%s/pulls/%d/merge"%(repo,pr_id,),
...
for repo in repos:
  req = requests.get('https://www.github.com/grohit/%s/pulls'%repo, auth=('grohit', OAUTH_KEY))
  data = req.json.decoder()
